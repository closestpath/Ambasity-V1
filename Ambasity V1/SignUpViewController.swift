...
class SignUpViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
...
// View Setup
    private func setupLayout() {
        [cancelButton, inputTextField, continueButton, pageControl, backButton].forEach {
            view.addSubview($0)
        }
...
// Button Targets
    ...
    @objc private func continueButton_TouchUpInside() {
        ...
        case 3:
            phoneNumber = inputTextField.text! as String
            signUpUser()
        default: break
        }
